...
(function (controllers) {
    ...
    (function (application) {
        ...
        var ApplicationDetailNav = (function () {
            ...
            ApplicationDetailNav.prototype.isSearchResultsActive = function () { return this.stApplicationDetailNavService.isActive(); };
            ApplicationDetailNav.prototype.activeListName = function () { return this.stApplicationDetailNavService.activeListName(); };
            ApplicationDetailNav.prototype.conditionsText = function () { return this.stApplicationDetailNavService.conditionsText(); };
            ApplicationDetailNav.prototype.existsNextItem = function () { return this.stApplicationDetailNavService.existsNextItem(); };
            ApplicationDetailNav.prototype.existsPrevItem = function () { return this.stApplicationDetailNavService.existsPrevItem(); };
            ApplicationDetailNav.prototype.currentItemNumber = function () { return this.stApplicationDetailNavService.currentItemNumber(); };
            ApplicationDetailNav.prototype.totalHits = function () { return this.stApplicationDetailNavService.totalHitsNumber(); };
            ApplicationDetailNav.prototype.transitionToNextItem = function () { this.stApplicationDetailNavService.transitionToNextItem(); };
            ApplicationDetailNav.prototype.transitionToPrevItem = function () { this.stApplicationDetailNavService.transitionToPrevItem(); };
            ApplicationDetailNav.prototype.backToList = function () { this.stApplicationDetailNavService.backToList(); };
        ...
        var ApplicationTimeline = (function () {
            ...
            ApplicationTimeline.prototype.listTimelineItems = function (app) {
                ...
                return _.sortBy(_.union(_.map(app.notes, function (i) { return { timelineType: _this.enums.timelineType.note, content: i }; }), _.map(app.interviews, function (i) {
                ...
                }), _.map(app.selectionHistory, function (i) { return { timelineType: _this.enums.timelineType.stage, content: i }; }), _.map(_.flatten(_.compact(_.pluck(app.interviews, 'feedbacks'))), function (i) { return { timelineType: _this.enums.timelineType.feedback, content: i }; }), [{ timelineType: this.enums.timelineType.message, content: app.message }]), function (i) {
                    if (!i.content) {
                        return;
                    }
            ...
            ApplicationTimeline.prototype.checkForInterviewVersionNoIncrement = function (updated) {
                ...
                if (updated.timelineType == this.enums.timelineType.feedback) {
                    angular.forEach(this.timeline, function (existing) {
                        if (existing.timelineType == _this.enums.timelineType.interview
                            || existing.timelineType == _this.enums.timelineType.docscreening) {
                ...
                if (this.timeline) {
                    ...
                    _.forEach(this.timeline, function (item) {
                        if (item.timelineType == typEnum.interview) {
                            var interviewFeedbacks = _.filter(feedbacks, function (fb) { return fb.interviewId == item.content.id; });
                            if (interviewFeedbacks == null)
                                interviewFeedbacks = [];
                            item.content.feedbacks = interviewFeedbacks;
                        }
                        else if (item.timelineType == typEnum.docscreening) {
                            var docFeedbacks = _.filter(feedbacks, function (fb) { return fb.interviewId == item.content.id; });
...
(function (service) {
    ...
    (function (interview_1) {
        var ApplicationDetailNavService = (function () {
            ...
            ApplicationDetailNavService.prototype.isActive = function () { return this.activeMode != null; };
            ApplicationDetailNavService.prototype.activeListName = function () { return this.activeMode.data.listName; };
            ApplicationDetailNavService.prototype.currentItemNumber = function () { return this.conditions.offset + this.indexOnPage + 1; };
            ApplicationDetailNavService.prototype.totalHitsNumber = function () { return this.totalHits; };
            ApplicationDetailNavService.prototype.existsNextItem = function () { return this.currentItemNumber() < this.totalHits; };
            ApplicationDetailNavService.prototype.existsPrevItem = function () { return this.currentItemNumber() > 1; };
            ApplicationDetailNavService.prototype.conditionsText = function () { return angular.toJson(this.conditions); };
        ...
        interview_1.ApplicationDetailNavService = ApplicationDetailNavService;
        ...
        (function (applications) {
            function initRouting() {
                ...
                angular.module('stanbyControllers')
                    ...
                    .provider('applicationControllers', function (enums) {
                    return {
                        $get: function () { return new controllers.application.ApplicationControllers(enums); }
                    };
                })
                    ...
                    .config(function ($stateProvider, $urlRouterProvider, applicationControllersProvider, enums) {
