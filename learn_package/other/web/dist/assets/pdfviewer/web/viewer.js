 ...
 *
 * -----------------------------------------------------------------------
 * For Stanby-ATS Modification: look for strings "Stanby-ATS" in this file.
 * - Changes presentationMode button behaviour if/if-not full-screen mode is supported
 * - Makes bookmark/openFile buttons invisible
 * -----------------------------------------------------------------------
 */
