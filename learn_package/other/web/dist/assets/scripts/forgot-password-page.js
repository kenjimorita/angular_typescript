...
(function (controllers) {
    ...
    (function (password) {
        var ForgotPassword = (function () {
            function ForgotPassword(routes) {
                this.routes = routes;
                this.isSent = false;
            }
            ForgotPassword.prototype.submit = function (form) {
                if (form.$invalid) {
                    return;
                }
                var that = this;
                this.routes.account.forgotPassword({ email: that.email }).success(function () {
                    that.isSent = true;
                });
            };
            return ForgotPassword;
        })();
        password.ForgotPassword = ForgotPassword;
    })(password = controllers.password || (controllers.password = {}));
    ...
    (function (routing) {
        ...
        (function (forgotpassword) {
            function initRouting() {
                angular.module('stanbyControllers').controller('ForgotPasswordCtrl', controllers.password.ForgotPassword).config(function ($stateProvider) {
            ...
            forgotpassword.initRouting = initRouting;
        })(forgotpassword = routing.forgotpassword || (routing.forgotpassword = {}));
    })(routing = stanby.routing || (stanby.routing = {}));
})(stanby || (stanby = {}));

stanby.routing.forgotpassword.initRouting();

//# sourceMappingURL=../scripts/forgot-password-page.js.map