...
(function (controllers) {
    ...
    (function (login) {
        var Login = (function () {
            function Login(routes, stUtils, $location) {
                this.routes = routes;
            ...
            Login.prototype.login = function (form) {
                ...
                var that = this;
                this.routes.account.login({ email: that.email, password: that.password }).success(function (data) {
                    location.href = _this.destination;
    ...
    (function (routing) {
        ...
        (function (login) {
            function initRouting() {
                angular.module('stanbyControllers').controller('LoginCtrl', controllers.login.Login).config(function ($stateProvider, $urlRouterProvider) {
...
//# sourceMappingURL=../scripts/login-page.js.map