...
(function (controllers) {
    ...
    (function (verify) {
        var VerifyForgotPassword = (function () {
            function VerifyForgotPassword($scope, routes, $stateParams, stUtils) {
                this.$scope = $scope;
                this.routes = routes;
                this.$stateParams = $stateParams;
                this.stUtils = stUtils;
                var token = $stateParams.token;
                this.routes.account.verifyForgotPassword(token).success(function () {
                    $scope.tokenValid = true;
                }).error(function (data, status) {
                    $scope.tokenInvalid = true;
                });
            }
            VerifyForgotPassword.prototype.resetPassword = function (form) {
                if (form.$invalid) {
                    return;
                }
                var data = { newPassword: this.newPassword, token: this.$stateParams.token };
                var that = this;
                this.routes.account.resetForgotPassword(data).success(function () {
                    that.$scope.resetComplete = true;
                });
            };
            return VerifyForgotPassword;
        })();
        verify.VerifyForgotPassword = VerifyForgotPassword;
    })(verify = controllers.verify || (controllers.verify = {}));
    ...
    (function (routing) {
        ...
        (function (verify) {
            function initRouting() {
                angular.module('stanbyControllers').controller('VerifyForgotPasswordCtrl', controllers.verify.VerifyForgotPassword).config(function ($stateProvider) {
                    $stateProvider.state('signup', {
                        url: '/signup/:token',
                        templateUrl: '/templates/account/verify-signup.html',
                        anonAllowed: true,
                        controller: function ($scope, routes, $stateParams) {
                            routes.account.verifySignup($stateParams.token).success(function () {
                                $scope.tokenValid = true;
                            }).error(function (data, status) {
                                if (status == 400) {
                                    $scope.tokenInvalid = true;
                        ...
                        anonAllowed: true,
                        controller: function ($scope, routes, $stateParams) {
                            routes.account.verifyEmailChange($stateParams.token).success(function () {
                                $scope.tokenValid = true;
                            }).error(function (data, status) {
                                if (status == 400) {
                                    $scope.tokenInvalid = true;
            ...
            verify.initRouting = initRouting;
        })(verify = routing.verify || (routing.verify = {}));
    })(routing = stanby.routing || (stanby.routing = {}));
})(stanby || (stanby = {}));

stanby.routing.verify.initRouting();

//# sourceMappingURL=../scripts/verify-page.js.map