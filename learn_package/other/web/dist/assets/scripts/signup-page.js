...
(function (controllers) {
    ...
    (function (register) {
        var SignUp = (function () {
            function SignUp($scope, $timeout, routes, stUtils, stModal) {
                this.$scope = $scope;
            ...
            SignUp.prototype.submit = function (form) {
                var that = this;
                this.routes.account.signup(this.model).success(function (data) {
                    that.stModal.modalAlert({
                        msg: 'メールアドレスの登録確認のメールを送信いたしました。<br>ご確認いただき、登録を完了させてください。',
                        okButton: 'ひきつづき求人を登録する'
                    }).result.finally(function () {
                        location.href = '/jobs?justRegistered#/add';
                    });
                }).error(function (xhr) {
    ...
    })(register = controllers.register || (controllers.register = {}));
    ...
    (function (routing) {
        ...
        (function (signup) {
            function initRouting() {
                angular.module('stanbyControllers').controller('SignUpCtrl', ['$scope', '$timeout', 'routes', 'stUtils', 'stModal', controllers.register.SignUp]).config(function ($stateProvider, $urlRouterProvider) {
            ...
            signup.initRouting = initRouting;
...
//# sourceMappingURL=../scripts/signup-page.js.map